...
pub struct World {
    ...
    pub players: IntMap<i8, Location>,
    /// A list of available player IDs.
    pub available_ids: ArrayVec<i8, 256>,
...
impl Default for World {
    fn default() -> Self {
        Self {
            ...
            level_data: LevelData::new(Vec::from(DEFAULT_LEVEL_DATA), Vector3 {x: 5, y: 7, z: 5}),
